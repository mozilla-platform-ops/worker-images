...
apt-get -o Acquire::Retries=10 -o APT::Update::Error-Mode=any -y reinstall linux-headers-gcp $header_package
...
apt-get -o Acquire::Retries=10 -o APT::Update::Error-Mode=any install -y dkms
...
apt-get -o Acquire::Retries=10 -o APT::Update::Error-Mode=any install linux-modules-extra-gcp -y
