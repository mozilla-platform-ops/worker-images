...
if (-not $SkipDevelopmentTools) {
    ...
    New-Item -ItemType Directory -Path "C:\DependencyWalker"
    ...
    New-Item -ItemType Directory -Path "C:\ProcessExplorer"
    ...
    New-Item -ItemType Directory -Path "C:\ProcessMonitor"
