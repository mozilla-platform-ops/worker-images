...
Invoke-DownloadWithRetry "https://raw.githubusercontent.com/mozilla-platform-ops/worker-images/win10hw_activate/provisioners/windows/MDC1Windows/bootstrap.ps1" -Path $local_bootstrap
